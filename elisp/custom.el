(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rubocop ample-theme helm-ag ## go-mode perspective projectile company noctilux ace-jump-mode helm-swoop wrap-region hungry-delete easy-kill fancy-narrow mic-paren
