 ...
 '(package-selected-packages
   (quote
    ((progn flycheck elisp--witness--lisp)
     guide-key rubocop ample-theme helm-ag ## go-mode perspective projectile company noctilux ace-jump-mode helm-swoop wrap-region hungry-delete easy-kill fancy-narrow mic-paren
