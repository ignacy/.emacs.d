...
(custom-theme-set-faces
 ...
 '(font-lock-keyword-face ((t (:weight bold :foreground "cyan2"))))
 '(font-lock-string-face ((t (:slant italic :foreground "RosyBrown"))))
 '(font-lock-type-face ((t (:weight bold :foreground "MediumSpringGreen"))))
