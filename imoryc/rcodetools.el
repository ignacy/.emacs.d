...
(defvar rct-doc-command-name "rct-doc --dev --fork --detect-rbtest"
  "The rct-doc command name.")
(defvar rct-complete-command-name "rct-complete --dev --fork --detect-rbtest"
  "The rct-complete command name.")
(defvar ruby-toggle-file-command-name "ruby-toggle-file"
  "The ruby-toggle-file command name.")
(defvar rct-fork-command-name "rct-fork")
