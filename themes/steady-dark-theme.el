...
(let (;; Palette
      (base4   "#303030") (base4-256   "#303030")
      (base3   "#404040") (base3-256   "#444444")
      (base2   "#505050") (base2-256   "#4e4e4e")
      (base1   "#707070") (base1-256   "#6c6c6c")
      (base0   "#b0b0b0") (base0-256   "#b2b2b2")
      (base-1  "#d0d0d0") (base-1-256  "#d0d0d0")
      (base-2  "#f0f0f0") (base-2-256  "#eeeeee")
      (red     "#e65856") (red-256     "#d75f5f")
      (orange  "#cd720f") (orange-256  "#d78700")
      (yellow  "#dcb000") (yellow-256  "#dfaf00")
      (green   "#8baa24") (green-256   "#87af00")
      (cyan    "#26aea1") (cyan-256    "#00afaf")
      (blue    "#2c91ed") (blue-256    "#0087ff")
      (violet  "#8f68f5") (violet-256  "#875fff")
      (magenta "#d255b6") (magenta-256 "#d75faf"))
  ;; Set attributes of the default face for existing frames and new frames.
  (set-face-attribute 'default nil :background base4 :foreground base0)
  (set-face-attribute 'cursor  nil :background base-1)
  ;; Custom theme
  (custom-theme-set-faces
   'steady-dark
   ;; Standard
   `(default        ((t :background ,base4 :foreground ,base0)))
   ...
   `(minibuffer-prompt  ((t :foreground ,base0)))
   ;; hlinum
