;;; minimo-theme.el --- An eye-candy theme for Emacser

;; Author: Matteo Banerjee <matteobanerjee@gmail.com>
...
(let ((class '((class color) (min-colors 89)))
      ...
      (orange-4 "#d75f00")
      (magenta-1 "#ff7bbb")
      (magenta-2 "#c61b6e") (magenta-3 "#ff1f8b")
      (green-1 "#8ec200") ;; (green-1 "#afff00") test setting green-1 to green-2
      (green-2 "#8ec200") (green-3 "#5f8700") (green-4 "#008700") (green-5 "#005f00")
      (blue-1 "#5fafd7") (blue-2 "#1f5bff") (blue-3 "#005f87") (blue-4 "#005faf") (blue-5 "#0000af") (blue-6 "#00005f")
      (cyan-1 "#5fd7af") (cyan-2 "#87d7af") (cyan-3 "#00d7af") (cyan-4 "#00ac8a") (cyan-5 "#5faf87") (cyan-6 "#005f5f") (cyan-7 "#005f87")
      ...
      (green-02 "#8ec200") (green-01 "#8ec200") (green-0 "#8ec200") (green-00 "#8ec200")
  ...
  (custom-theme-set-faces
   ...
   (set-face-attribute 'minibuffer-prompt nil :background nil :foreground blue-1 :bold t)
   ...
   `(help-argument-name ((,class (:foreground ,magenta-2 :italic t))))
   ...
   ;; Font lock faces
   `(scala-font-lock:private-face ((,class (:foreground ,orange-2))))
   `(font-lock-builtin-face ((,class (:foreground ,blue-1))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,black-2-5 :slant italic))))
   `(font-lock-comment-face ((,class (:foreground ,black-2-5))))
   `(font-lock-constant-face ((,class (:foreground ,cyan-1))))
   `(font-lock-doc-face ((,class (:foreground ,white-3 :italic t))))
   `(font-lock-doc-string-face ((,class (:foreground ,white-3 :italic t))))
   `(font-lock-function-name-face ((,class (:foreground ,yellow-2))))
   `(font-lock-keyword-face ((,class (:foreground ,orange-2))))
   ...
   `(font-lock-variable-name-face ((,class (:foreground ,yellow-3))))
   ...
   ;; `(org-footnote ((,class (:foreground ,magenta-2))))
   ...
   `(markdown-link-face ((,class (:foreground ,magenta-2 :underline t))))
   ...
   `(markdown-math-face ((,class (:foreground ,magenta-2))))
   ...
   `(markdown-url-face ((,class (:foreground ,magenta-2 :underline ,magenta-2))))
   ...
   ;; `(gnus-cite-10 ((,class (:foreground ,magenta-2 :background ,black-4 :slant italic))))
   ...
   `(diredp-flag-mark ((,class (:foreground ,white-1 :background ,magenta-2 :bold t))))
   `(diredp-flag-mark-line ((,class (:foreground ,black-5 :background ,magenta-2))))
   `(diredp-ignored-file-name ((,class (:foreground ,black-2))))
   `(diredp-link-priv ((,class (:foreground ,magenta-2))))
   `(diredp-mode-line-flagged ((,class (:foreground ,black-5 :background ,green-2))))
   `(diredp-mode-line-marked ((,class (:foreground ,white-1 :background ,magenta-2 bold t))))
   ...
   `(diredp-symlink ((,class (:foreground ,magenta-2))))
   ...
   `(magit-log-reflog-label-amend ((,class (:foreground ,magenta-2 :background ,magenta-0))))
   ...
   `(git-commit-pseudo-header-face ((,class (:foreground ,magenta-2))))
   ...
   `(ediff-current-diff-C ((,class (:background ,orange-4))))
   ...
   ;; CUA
   `(cua-rectangle ((,class (:background ,magenta-2 :foreground ,white-1))))
   ...
   `(term-color-magenta ((,class (:background ,magenta-2 :foreground ,magenta-2))))
   ...
   `(ido-virtual ((,class (:foreground ,magenta-2))))
...
;;   `(cfw:face-title ((,class (:foreground , :background ,))))
   ...
   `(swoop-face-target-words ((,class (:foreground ,magenta-2 :background ,black-2-5 :bold t))))
   ...
   `(helm-swoop-target-word-face ((,class (:foreground ,magenta-2 :background ,magenta-0 :bold t))))
...
(provide-theme 'minimo)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; minimo-theme.el ends here
