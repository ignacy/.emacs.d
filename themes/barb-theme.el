...
;;; barb-theme.el --- Emacs 24 theme with a dark background.
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
  ...
  `(cursor ((,class (:background ,bg3))))
        ...
        `(mode-line ((,class (:box (:line-width 1 :color nil :style released-button) :bold nil :foreground ,fg4 :background ,bg2))))
        `(mode-line-inactive ((,class (:box (:line-width 1 :color nil :style pressed-button) :foreground ,fg2 :background ,bg1))))
        `(mode-line-buffer-id ((,class (:bold nil :foreground ,fg2 :background nil))))
  ...
  `(org-hide ((,class (:foreground ,fg4))))
        ...
        `(org-todo ((,class :foreground ,keyword :bold nil)))
        `(org-done ((,class (:bold nil :foreground ,bg4))))
  ...
  `(slime-repl-inputed-output-face ((,class (:foreground ,type))))
        ...
        `(company-tooltip ((,class (:foreground ,fg2 :background ,bg1 :bold nil))))
